...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.delay_between_each_email'
        db.add_column(u'newsletter_newsletter', 'delay_between_each_email',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.delay_between_each_email'
        db.delete_column(u'newsletter_newsletter', 'delay_between_each_email')
    ...
    models = {
        ...
        u'newsletter.article': {
            ...
            'sortorder': ('django.db.models.fields.PositiveIntegerField', [], {'default': '60', 'db_index': 'True'}),
        ...
        u'newsletter.newsletter': {
            ...
            'delay_between_each_email': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'site': ('django.db.models.fields.related.ManyToManyField', [], {'default': '[4]', 'to': u"orm['sites.Site']", 'symmetrical': 'False'}),
        ...
        u'newsletter.submission': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'default': '6', 'to': u"orm['newsletter.Message']"}),
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'057923a81b853478a060ff13fb321c1004bc707b'", 'max_length': '40'}),
